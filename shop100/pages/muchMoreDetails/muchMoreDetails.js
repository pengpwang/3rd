...
Page({
  ...
  getData: async function (id) {
    let url = '/bidding/' + id + '.html'
    let data = await request(url, {}, true, 'GET')
    this.setData({
      data: data.data,
      productStock: data.data.actBidding.stock
    })
  ...
  addNum() {
    let limitNum = this.data.data.actBidding.purchase
  ...
  async buyNow() {
    let stock = this.data.data.actBidding.stock
    let limitNum = this.data.data.actBidding.purchase
    ...
    wx.navigateTo({
      url: '/pages/orderBidding/orderBidding?productId=' + this.data.data.product.id + '&goodsId=' + this.data.productGoodsId + '&sellerId=' + this.data.data.seller.id + '&biddingId=' + this.data.data.actBidding.id + '&buyNum=' + buyNum
    })
  },
})